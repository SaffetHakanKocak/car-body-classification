...
MICRO_CANDIDATES_DIR = EXTERNAL_DATASETS_DIR / "micro_candidates"
...
def main():
    print("MICRO aday gorsel indirme islemi baslatiliyor...")
    prepare_directories()
    ...
    print(f"micro_candidates toplam aday gorsel sayisi: {count_candidate_images()}")
